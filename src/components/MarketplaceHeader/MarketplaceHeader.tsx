...
export function MarketplaceHeader({
  ...
  return (
    <header className="bg-white px-8 pt-7 pb-8">
      <div className="flex max-w-full flex-col items-start gap-5">
        <a
          href="/"
        ...
        <h1 className="text-[28px] leading-tight font-bold tracking-tight text-black md:text-[32px]">
          Marketplace
        </h1>
        <nav
          ...
          {categories.map((label) => {
            ...
            return (
              <button
                key={label}
                type="button"
                className="rounded-lg px-4 py-2.5 text-sm font-medium text-black transition-colors"
                style={{
